...
Lonestar Tracking is an online tracking platform provided by our satellite tracking provider for our SolarOne GPS units. This platform provides updates on previous and current positions of our pole buoys. Each GPS has it's own track. The tracks can only be displayed one at a time on the website.

![Figure 1. Lonestar SolarOne GPS tracking interface.](images/LoneStar_Update.jpg)
