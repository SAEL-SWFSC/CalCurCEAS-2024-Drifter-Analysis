...
2.  Slow to 5 kts when within one nautical mile of the last known location

    -   During daylight hours, ask the crew or visual team to use binoculars to aid in finding the buoy.
...
6.  Retrieve the main line down to the subsurface gear and gently wrap it around the power capstan to pull in. Make sure that one person keeps an eye on the line as it is being pulled aboard so that it doesn't chaff on the ship and so that you can see the subsurface gear as it approaches the surface.
