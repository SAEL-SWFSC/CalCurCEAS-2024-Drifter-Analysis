...
this link
\[<https://github.com/SAEL-SWFSC/CalCurCEAS-2024-Drifter-Analysis/issues>\]
to create an Issue, and use the BW-ID label for the issue.

*Note*: IPI= inter-pulse interval, PPS= pulses per sec

### GOBW: *Ziphius cavirostris*, goose-beaked whale
...
### BBWH: *Berardius bairdii*, Baird's beaked whale
...
### GTBW (formerly BW43): *Mesoplodon gingkodens,* Gingko-toothed whale Peak:43 kHz
...
### STBWH: *Mesoplodon stejnigeri*, Stejneger's beaked whale
...
### BLBW: *Mesoplodon densirostris*, Blainville's beaked whale.
...
### HUBW (formerly BW37V): *Mesoplodon carlhubbsi,* Hubb's beaked whale
