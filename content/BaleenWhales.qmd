...
To adapt the detector to CalCurCEAS acoustic conditions, recordings from **CalCurCEAS_008** and **CalCurCEAS_014** were fully annotated for focal call types and incorporated into the training data. These deployments represented different acoustic environments and were supplemented with additional sei whale downsweep annotations from sonobuoy recordings to expand the training data. The broader training dataset included recordings from multiple passive acoustic monitoring platforms and environments.
