...
params: 
  ...
  path_pg: 'Z:/drifting_recorder/1_Binaries-Database/2024_CalCurCEAS' # must use drive letter (not //)
  path_dets: 'Z:/drifting_recorder/2_Acoustic-Studies/2024_CalCurCEAS' # path to AcousticStudies
  # path_code: 'Z:/LLHARP/processingCode/llamp' # path to code (if not using r proj/here package)
  path_to_refSpec: 'C:/Users/pam_user/Documents/GitHub/CalCurCEAS-2024-Drifter-Analysis/_code/refSpec'
