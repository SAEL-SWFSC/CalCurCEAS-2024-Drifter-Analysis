---
title: "Summary Plots and Statistics for DASBR Sperm Whale Events"
subtitle: 'Summary tables and plots to aid in manual assessment of potential sperm whale events in DASBR data'
author: "Jenny Trickey"
...
params: 
  ...
  mission: MACS_2018 # for report printing/building filenames
  drift: DS3
  channelStr: ch1
  channelNum: 1
  # pgver: PAM20210a # string e.g., pam20207b, doesn't need quotations, for making file names
  path_pg: 'Q:/MACS_2018_DASBR/Post_Processing/Original' # must use drive letter (not //)
  path_dets: 'R:/McCullough/Pm_AcousticStudies/MACS_2018' # path to AcousticStudies
  # path_code: 'Z:/LLHARP/processingCode/llamp' # path to code (if not using r proj/here package)
  path_to_refSpec: 'G:/GitHub/SpermWhale_DASBR/refSpec'
...
## Trip/drift: `r paste0(params$mission, params$drift)`
...
detsFile <- file.path(params$path_dets, paste0(params$mission, '_', params$drift, '_Filtered.rdata'))
detsFiltFile <- file.path(params$path_dets, 
                          paste0(params$mission, '_', params$drift, '_', params$channelStr, '.rdata'))
...
source(here('functions', 'loadMultiBinaries.R'))
source(here('functions', 'plotContours.R'))
source(here('functions', 'clickSummary.R'))
source(here('functions', 'whistleSummary.R'))
